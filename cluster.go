...
import (
	...
	"github.com/gumeniukcom/kdbush"
)

// InfinityZoomLevel That Zoom level indicate impossible large zoom level (Cluster's max is 21)
...
// GeoPoint all object, that you want to cluster should implement this protocol
type GeoPoint interface {
	GetCoordinates() GeoCoordinates
}

// ClusterPoint Struct that implements clustered points
...
// ClusterPoints ClusterPoint get points and create multilevel clustered indexes
